...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(9935));
const api_calls_1 = __nccwpck_require__(1086);
            ...
            try {
                ...
                if (convert_quotes) {
                    Object.keys(task).forEach(function (key) {
                        ...
                        if (typeof value === 'string') {
                            task[key] = convertQuotesToHtml(value);
                        }
                    });
                }
                tasks.push(task);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const get_tasks_1 = __importDefault(__nccwpck_require__(4728));
(0, get_tasks_1.default)();
